package ru.podolian.Project2Boot.services;
...
import ru.podolian.Project2Boot.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public List<Book> getBooksByPersonId(int id) {
        ...
        person.get().getBooks().forEach(book -> book.setExpired(expiredCheck(book.getPicked())));
